  ...
  return (
    <div className="home_header-container">
      ...
      <div className="home_link-container">
        <NavLink to="/product" className="home_link-inside-container">
          Product
        </NavLink>
        <NavLink to="/resource" className="home_link-inside-container">
          Resources
        </NavLink>
        <NavLink to="/pricing" className="home_link-inside-container">
          Pricing
        </NavLink>
        <NavLink
          to="/signup"
